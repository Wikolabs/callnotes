...
export const metadata: Metadata = { title: "CallNotes — Notes d'appel IA, CRM mis a jour en 30 secondes", description: "Transcription, resume, actions extraites et CRM synchronise automatiquement apres chaque appel. 5h/semaine economisees." };
